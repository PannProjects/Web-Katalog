...
@section('title', 'Edit Produk — Web Katalog')
        ...
        <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <img
                    ...
                    alt="{{ $product->title }}"
                    class="w-32 h-32 rounded-xl object-cover bg-gray-100"
                >
            </div>
            ...
            <div>
                ...
                >
                <p class="text-xs text-gray-400 mt-1">Kosongkan jika tidak ingin mengganti foto. Maks 2MB.</p>
            </div>
